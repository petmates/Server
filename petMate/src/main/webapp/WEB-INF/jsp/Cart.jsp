...
<!------ Include the above in your HEAD tag ---------->
    ...
    <div class="container" id="tourpackages-carousel">
      <div class="row">
        <div class="col-lg-12"><h1>&nbsp;&nbsp;&nbsp;Shopping Cart</h1><h2>Sub Total: <%=cart.getSubTotal() %>  WON</h2>
        
        <% if(cart.getNumberOfItems() > 0){%>
        <br>
       	<br>
      	<div class="btn icon-btn btn-primary pull-right">
          <a href='<c:url value="/checkout.do"/>'><font size ="5">CHECK OUT</font></a>
        </div></div>
     <%} else{%>
     	</div>
     	<%} %>
          		...
          		<div class="thumbnail">
              		<div class="caption">
                		...
                		<div class='col-lg-12 well well-add-card'>
                    		<h4><a class="glyphicon glyphicon-credit-card" href="/viewItem.do?itemId=<%=item.getI_idx() %>">  <%=item.getI_idx() %></a></h4>
                    	</div>
                    	<div class='col-lg-12'>
                    		<p><%=item.getI_title()%></p>
                    		<p><%=item.getI_date()%></p>
